...
class LoadingIndicatorCard extends StatefulWidget {
  @override
  State<LoadingIndicatorCard> createState() => LoadingTextAnimationState();
}

class LoadingTextAnimationState extends State<LoadingIndicatorCard>{
