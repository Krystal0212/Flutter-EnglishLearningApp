...
class _FillWordQuizPageState extends State<FillWordQuizPage>
  ...
  bool isAnsweredCorrectly(Word word){
    String answer = widget.isChangeLanguage?word.vietnamese!.toLowerCase().toString()
              ...
              children: [
                ...
                Padding(
                  ...
                  child: AnimatedSwitcher(
                    duration: const Duration(milliseconds: 300),
                    child: isAnswered(currentIndex)?
                    userRevealAnswerWidget(currentIndex) : userInputFieldWidget(word),
                  ),
                ),
              ],
            ),
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context,index){
                    ...
                    if (selectedSummaryOption == 1){
                      ...
                      filteredUserInputResult = userInputResult;
                      borderColor = finishedCardCorrectly.contains(index)? Colors.green
                          : skippedCard.contains(index)? Colors.grey: Colors.red;
                      tileColor = finishedCardCorrectly.contains(index)? Colors.green[200]
                    ...
                    return Container(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text('Your answer: ${filteredUserInputResult[index]}',),
                        title: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Expanded(
